...
enqueue_compss --qos=debug --job_name=quantum  --log_level=off  --scheduler=es.bsc.compss.scheduler.fifodatanew.FIFODataScheduler --worker_in_master_cpus=0 --worker_working_dir=/gpfs/scratch/bsc19/compss/COMPSs_Sandbox/ --max_tasks_per_node=48 --exec_time=60 --num_nodes=2 --python_interpreter=python3 --pythonpath=/home/bsc19/bsc19776/my_apps/dislib hybrid_optimization.py
